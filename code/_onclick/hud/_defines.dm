...
#define ui_temp "RIGHT-1:28,CENTER-2:13"
#define ui_health "RIGHT-1:28,CENTER-1:15"
#define ui_internal "RIGHT-1:28,CENTER:17"
									//borgs
#define ui_borg_health "RIGHT-1:28,CENTER-2:13" //borgs have the health display where humans have the pressure damage indicator.
#define ui_alien_health "RIGHT-1:28,CENTER-2:13" //aliens have the health display where humans have the pressure damage indicator.
